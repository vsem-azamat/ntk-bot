...
async def change_gpt_answer_probability(message: types.Message):
    ...
    builder.add(
        types.InlineKeyboardButton(text="2.5%", callback_data="gpt_0.025"),
        types.InlineKeyboardButton(text="5%", callback_data="gpt_0.05"),
        types.InlineKeyboardButton(text="10%", callback_data="gpt_0.1"),
        types.InlineKeyboardButton(text="15%", callback_data="gpt_0.15"),
        types.InlineKeyboardButton(text="20%", callback_data="gpt_0.2"),
        types.InlineKeyboardButton(text="disable", callback_data="gpt_disable"),
    )
    builder.adjust(2)
    await message.reply(text="Choose GPT answer probability:", reply_markup=builder.as_markup())
